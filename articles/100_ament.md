...
Support for different build systems is integrated through extension points which allows the implementation of other build types without changing the ament tool itself.
